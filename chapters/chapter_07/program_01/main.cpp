...
void func() { 
    ...
    sync_out << "[" << std::this_thread::get_id() << "]" << "Using function pointer" << std::endl; 
}
...
class FuncObjectClass {
    ...
    void operator()() { 
        sync_out << "[" << std::this_thread::get_id() << "]" << "Using function object class" << std::endl; 
    }
};
...
int main() {
    ...
    auto lambda_func = []() { 
        ...
        sync_out << "[" << std::this_thread::get_id() << "]" << "Using lambda function\n"; 
    };
    ...
    auto fut3 = std::async( []() { 
        ...
        sync_out << "[" << std::this_thread::get_id() << "]" << "Using embedded lambda function\n"; 
    });
    ...
    class Obj {
        ...
        void func() { 
            ...
            sync_out << "[" << std::this_thread::get_id() << "]" << "Using a non-static member function\n"; 
        }
        
        static void static_func() { 

            sync_out << "[" << std::this_thread::get_id() << "]" << "Using a static member function\n"; 
        }
    };
